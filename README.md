# AlexMYH.github.io. [![Analytics](https://ga-beacon.appspot.com/UA-73784599-1/welcome-page)](https://github.com/AlexMYH/AlexMYH.github.io)
...
- [Put in a AlexMYH.github.io Plug](#put-in-a-AlexMYH.github.io-plug)
- [Upgrading AlexMYH.github.io](#upgrading-AlexMYH.github.io)
  - [Ensure there's an upstream remote](#ensure-theres-an-upstream-remote)
  - [Pull in the latest changes](#pull-in-the-latest-changes)
- [Todo](#todo)
- [Donate AlexMYH.github.io](#donate-AlexMYH.github.io)
- [Wiki](#wiki)
- [Ad](#ad)
...
Here is a [document](https://AlexMYH.github.io/AlexMYH.github.io/html/2017/01/31/3-steps-to-setup-website-with-AlexMYH.github.io.html) of how to setup this theme with 3 steps and a [wiki](https://github.com/AlexMYH/AlexMYH.github.io/wiki/How-to-add-posts) of how to add posts. If you have any **questions** please ask me at [GitHub Issues](https://github.com/AlexMYH/AlexMYH.github.io/issues).
...
The pagination in jekyll is not very perfect,so I use front-end web method,there is a [blog](http://www.AlexMYH.com/html/2016/06/04/jekyll-pagination-with-jpages.html) about the method and you can refer to [jPages](http://luis-almeida.github.io/jPages).

## Page views counter

Many third party page counter platforms are too slow,so I count my website page view myself,the javascript file is [static/js/count.min.js](https://github.com/AlexMYH/AlexMYH.github.io_jekyll_theme/blob/gh-pages/static/js/count.min.js) ([static/js/count.js](https://github.com/AlexMYH/AlexMYH.github.io_jekyll_theme/blob/gh-pages/static/js/count.js)),the backend API is written with flask on [Vultr VPS](https://www.vultr.com/), detail code please see [ztool-backhend-mongo](https://github.com/Z-Tool/ztool-backhend-mongo).
...
About how to custom multilingual page, please see [wiki](https://github.com/AlexMYH/AlexMYH.github.io/wiki/Multilingual-Page).
...
![search](https://github.com/AlexMYH/AlexMYH.github.io/raw/master/readme_files/search.gif)
...
# Put in a AlexMYH.github.io Plug

If you want to give credit to the AlexMYH.github.io theme with a link to my personal website <http://www.AlexMYH.com>, that'd be awesome. No worries if you don't.

# Upgrading AlexMYH.github.io

AlexMYH.github.io is always being improved by its users, so sometimes one may need to upgrade.
...
```
git remote add upstream https://github.com/AlexMYH/AlexMYH.github.io.git
```
...
* [Multilingual Page](https://github.com/AlexMYH/AlexMYH.github.io/wiki/Multilingual-Page)
* [How to add posts](https://github.com/jAlexMYH/AlexMYH.github.io/wiki/How-to-add-posts)
* [Change Log](https://github.com/AlexMYH/AlexMYH.github.io/wiki/Change-Log)
* [Contributors](https://github.com/AlexMYH/AlexMYH.github.io/wiki/Contributors)
* [Thanks to the following](https://github.com/AlexMYH/AlexMYH.github.io/wiki/Thanks-to-the-following)
